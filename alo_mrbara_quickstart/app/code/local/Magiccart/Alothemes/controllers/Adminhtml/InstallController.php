 ...
 * @@Modify Date: 2016-06-07 23:55:31
 * @@Function:
 */
?>
<?php
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try 
            {
                if ($action == '1') {
                    ...
                    if($data['pages']=='1') Mage::getSingleton('alothemes/import_cms')->deleteCmsItems('cms/page', 'pages', $data['theme'], $stores);
                    if($data['blocks']=='1') Mage::getSingleton('alothemes/import_cms')->deleteCmsItems('cms/block', 'blocks', $data['theme'], $stores);
